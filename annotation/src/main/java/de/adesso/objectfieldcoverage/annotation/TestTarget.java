...
public @interface TestTarget {
     ...
     * the JavaDoc notation. Must be a non-void method or a constructor. All parameter types not in the <em>java.lang</em>
     * package must by fully qualified. Generic methods and constructors are supported as well.
     * <p/>
